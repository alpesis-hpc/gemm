...
void gemm_benchmark (int m, int n, int k, 
                     float alpha, 
                     float * A, int lda, 
                     float * B, int ldb, 
                     float beta, 
...
void test_gemm_benchmark (void)
{
  ...
  gemm_benchmark (m, n, k, alpha, A, lda, B, ldb, beta, C, ldc);
